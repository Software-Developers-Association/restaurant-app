...
export default function PostCard(props) {
    ...
    return (
        <div
            className="inline-block self-start w-32 sm:w-40 lg:w-48 xl:w-56 rounded-lg overflow-hidden shadow-lg hover:shadow-xl transform hover:scale-105 duration-150 bg-white">
            <div>
